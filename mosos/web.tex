...
\item
    %\begin{tcolorbox}[colback=yellow!50!white]
    
    The first course \textbf{MCFSI} is part of the curriculum of the last yer
...
\section{Course MCFSI  at Telecom Nancy academic year 2026/2027}
\label{sec:course-mcfsi-at}

Updated version of \today.
...
\subsubsection{Lecture 1  (CM1 \& CM2) 
  \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mcfsi-lect1.pdf}{The 
    Modelling Language Event-B}. 
}

Current state of lectures \today



\subsubsection{Lecture 2
    \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mcfsi-lect2.pdf}{Proof Obligation Generation  for Machines  and
  Verification Machines }.}



  \subsubsection{Lecture 3
    \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mcfsi-lect3.pdf}{Correctness by Construction with the  
...
\subsubsection{Lecture 4
    \href{http://mery54.github.io/teaching/mosos/lecturesnotes/amcfsi-lect4.pdf}{Checking
      contracts using Event-B}.}

  

\subsubsection{ Lecture 5 
    \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mcfsi-lect5.pdf}{Access 
      Control }}


  
\subsubsection{ Lecture 6
  \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mcfsi-lect6.pdf}{
Validation, Verification and Proof Tools for 
  Event-B for Correct-by-Construction}}
...
\subsection{Tutorials}
  ...
  \item[]   Tutorial 1
    ...
    \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mcfsi-td4.pdf}{Using 
      the refinement in 
      the Event-B modelling language  for deriving  systems}. 
  ...
  \subsection{Project  for academic year 2026/2027}
\label{sec:project}

The assessment  of students is based on two works:
\begin{itemize}
\item A first project  on verification  which is stated  in the following
  document  \href{http://mery54.github.io/teaching/mosos/lecturesnotes/project-verification2026.pdf}{Projet
    Vérificatipn    3A IL}  and the deadline is November 15,2026.
  Students should send a list of 2-students groups  to Dominique Méry
  and each group should choose a subject  from the list  of possible
  subjects.  The relation between groups and subjects is an injection.
\item A second project which is stated in the following document \href{http://mery54.github.io/teaching/mosos/lecturesnotes/telecom-projects2627.pdf}{Projet
    Correction par construction 
    3A IL}   and the deadline for the project is  February 1, 2027 and the presentation 
is organised on    Moday  February ??. 2026. 
\end{itemize}
...
% \href{http://mery54.github.io/teaching/mosos/lecturesnotes/
 %  ex-safety.zip}{Archive Rodin  for  explaining differences between 
  % Event-B invariant and Event-B theorem. }

 
 \href{http://mery54.github.io/teaching/mosos/models/mcfsi0-safety.zip}{Archive Rodin  for  explaining differences between 
...
% ex-school.zip}{Archive Rodin  for   the management of school. }
 ...
 \href{http://mery54.github.io/teaching/mosos/models/mcfsi0-school.zip}{Archive Rodin  for   the management of school. }
...
% \href{http://mery54.github.io/teaching/mosos/lecturesnotes/
  ...
  \href{http://mery54.github.io/teaching/mosos/models/mcfsi0-clock.zip}{Archive Rodin  for  clock modelling. }


  \href{http://mery54.github.io/teaching/mosos/models/mcfsi0-agents.zip}{Archive
    Rodin  for  communicating agents modelling. }


 \href{http://mery54.github.io/teaching/mosos/models/mcfsi0-alg-simple.zip}{Archive
    Rodin  for  verifying a simple contract. }

 
  \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mcfsi0-factorial.zip}{Archive Rodin  for   modelling  the 
   design of the factorial function.}

  \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mcfsi0-factorial1.zip}{Archive Rodin  for   modelling  the 
   design of the factorial1 function.}

  \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mcfsi0-factorial2.zip}{Archive Rodin  for   modelling  the 
   design of the factorial2 function.}
...
\href{http://mery54.github.io/teaching/mosos/models/mcfsi1-ex10.zip}{Archive 
  Rodin   mcfsi1-ex10.zip.}
...
\href{http://mery54.github.io/teaching/mosos/models/mcfsi3-ex6.zip}{Archive 
  Rodin  mcfsi3-ex6.zip.}



\href{http://mery54.github.io/teaching/mosos/codes/power3.c}{Fichier 
  power2.c.}
...
\subsubsection{ Lecture 2 
    \href{http://mery54.github.io/teaching/mosos/lecturesnotes/masterillectcm2.pdf}{Proof        Obligations}.}
...
\subsubsection{Event-B Archives for the  lectures}
 ...
 \href{http://mery54.github.io/teaching/mosos/models/
   ex0-accesscontrol.zip}{Archive Rodin  for   the access control system. }
 ...
 \href{http://mery54.github.io/teaching/mosos/lecturesnotes/
   ex0-factorial.zip}{Archive Rodin  for   the fctorial function. }
...
\href{http://mery54.github.io/teaching/mosos/models/ex11-tut1.zip}{Archive 
  Rodin   ex11-tut1.zip.}
...
We give  two solutions using  the variable ok or not.
...
\item A project which is stated in the following document
  \href{http://mery54.github.io/teaching/mosos/lecturesnotes/master-projets2526.pdf}{Projet
    Master } 
\end{itemize}

The deadline for the project is  February 15, 2027 and the presentation
will be  organised later in February 2027. 
...
I have been teaching this course for a number of years as part of the
Masters in Computer Science at Maynooth University.  The idea is to
make the link with what has been seen before, in particular the
contracts in the DAFNY framework, and I give a few hours to explain
the Event-B approach.      Rosemary Monahan is the course tutor and
welcomes me to the course.   I've been running this university exchange week for my school since 1998.
...
\subsection{Tutorials for EMU}


  
   \subsubsection{Master Tutorial  1 
    \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mastertutorial1.pdf}{Tutorial
      Notes 1}.}
\label{sec:tuthrefhttp:mb}


\subsubsection{Master Tutorial  2
    \href{http://mery54.github.io/teaching/mosos/lecturesnotes/mastertutorial2.pdf}{Tutorial
      Notes 2}.}
\label{sec:tuthrefhttp:mb}
