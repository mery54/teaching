...
CONSTANT MAXINT,x10,x20

(*
--algorithm gcdscm {
  variables x1 =x10; (* 1st integer *)
            x2 = x20;  (* 2nd integer *)
            y1;
            y2;
            y3;
...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "ab42efb3" /\ chksum(tla) = "9f011883")
...
\* Last modified Wed Nov 29 16:59:35 CET 2023 by mery
