...
*)    
\* BEGIN TRANSLATION (chksum(pcal) = "99be29fe" /\ chksum(tla) = "54c15cec")
...
Checkfalse == output = <<>>
Invcommunication == output # <<>> =>\A i \in 1..Len(output): output[i] = input[i] 
test == Invcommunication
